          ...
          <Header />
            ...
            <main style={{paddingLeft: '2em', paddingRight: '2em'}}>
              <article style={{marginLeft: 'auto', marginRight: 'auto', maxWidth: '700px', opacity: .7, fontWeight: 300, marginTop: 50}}>
                  ...
                  <p>Possui experiência com JavaScript (vanilla e frameworks como React, NextJS, Gatsby, Nuxt e NodeJS), TypeScript C#, Swift (iOS e watchOS), Python e a Adobe Creative Suite.</p>
              </article>
